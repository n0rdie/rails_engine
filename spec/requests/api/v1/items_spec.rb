...
RSpec.describe "Api::V1::Items", type: :request do
  describe "GET /api/v1/items" do
    ...
    it "returns all items" do
      ...
      expect(json_response["data"].first["attributes"]).to include("id", "name", "description", "unit_price")
      expect(json_response["data"].last["attributes"]).to include("id", "name", "description", "unit_price")
    end
  end
  ...
  describe "GET /api/v1/items/:id" do
    ...
    it "returns specified item attributes" do
      ...
      expect(json_response["data"]["attributes"]).not_to have_key("merchant_id")
    end
  end
end